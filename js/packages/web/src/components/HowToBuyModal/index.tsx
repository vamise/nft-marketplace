      ...
      cardProps={[
        {
          ...
          description: `SOL is the cryptocurrency we use for purchases on ${LABELS.STORE_NAME}. To keep your Solana (SOL) safe, you’ll need a crypto wallet—we recommend using one called Phantom. Just head to Phantom’s site, install the Chrome extension, and create an account.`,
        },
        {
