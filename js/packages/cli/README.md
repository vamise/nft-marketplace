...
- JSON format can be checked out here: https://docs.nft.fyfy.io/nft-standard. example below:
...
1. Upload your images and metadata. Refer to the NFT [standard](https://docs.nft.fyfy.io/nft-standard) for the correct format.
