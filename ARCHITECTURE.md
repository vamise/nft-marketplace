...
The instruction set for the token metadata contract can be found here: https://github.com/vamise/nft-marketplace/blob/master/token-metadata/program/src/instruction.rs
