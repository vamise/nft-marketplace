...
pub enum MetaplexInstruction {
    ...
    ///   3. `[writable]` Payout ticket info to keep track of this artist or auctioneer's payment, pda of [nft-marketplace, auction manager, winning config index OR 'participation', safety deposit key]
    ///   4. `[signer]` payer
    ///   5. `[]` The metadata
